...
The GitHub repository is structured with each chapter of the prospective book in a different directory. In each chapter's directory, there is another directory containing the 'paragraphs' (the fragmentary text that will form the basis of the book) in Markdown format. These are the principal content of the book: read through them carefully, either keeping notes in another piece of software or creating line-by-line issues as you go.

## logging a general comment

To log an issue, click 'New issue' on the issues page. 

![screenshot of the GitHub page for logging a new issue](peer_review/Screenshot 2024-11-25 at 14.06.54.png)

This page invites you to add a title which should be a short summary of your comment and a description which should be your peer review comment in full with any appropriate links or screenshots or additional material. 

## logging a line-by-line comment
...
![screenshot of the code view of a file in GitHub](peer_review/Screenshot 2024-11-25 at 15.58.43.png)
...
![screenshot of the GitHub issue page and adding a label](peer_review/Screenshot 2024-11-25 at 14.37.53.png)
